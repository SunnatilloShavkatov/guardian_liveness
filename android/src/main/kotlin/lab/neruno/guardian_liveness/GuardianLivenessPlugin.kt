package lab.neruno.guardian_liveness
...
class GuardianLivenessPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
...
//    private const val EVALUATE_LIVENESS = "evaluateLiveness"
    ...
    fun registerWith(registrar: Registrar) {
      ...
      channel.setMethodCallHandler(GuardianLivenessPlugin())
    }
  }
